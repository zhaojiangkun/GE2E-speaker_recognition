...
data_arg.add_argument('--noise_path', type=str, default='./noise_tdsv/', help="noise dataset directory")
data_arg.add_argument('--train_path', type=str, default='./train_tisv/vctk_mfcc_fbank/', help="train dataset directory")
data_arg.add_argument('--test_path', type=str, default='./test_tisv/vctk_mfcc_fbank/', help="test dataset directory")
...
model_arg.add_argument('--model_path', type=str, default='./tisv_mfcc_model/', help="model directory to save or load")
...
train_arg.add_argument('--iteration', type=int, default=50000, help="max iteration")
